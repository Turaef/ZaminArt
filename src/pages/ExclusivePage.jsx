        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">
              Eksklyuziv Pollar Kollektsiyasi
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Bizning eksklyuziv kollektsiyamiz faqat eng taniqli dizaynerlar tomonidan yaratilgan. 
              Har bir pol o'ziga xos va takrorlanmasdir.
            </p>
          </motion.div>
        </div>
      </section>
      
      <Gallery model="exclusive" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                Eksklyuziv pollar bo'yicha konsultatsiya olishni xohlaysizmi?
              </h2>
