        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">
              Zamonaviy Pollar Kollektsiyasi
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Bizning zamonaviy pollar kollektsiyamiz innovatsion dizayn va yangi texnologiyalarni o'z ichiga oladi.
              Ular zamonaviy turar joy va tijorat joylarini bezash uchun ideal hisoblanadi.
            </p>
          </motion.div>
        </div>
      </section>
      
      <Gallery model="modern" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                Zamonaviy pollar bo'yicha konsultatsiya olishni xohlaysizmi?
              </h2>
