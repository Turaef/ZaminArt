...
export default function KafelPage() {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">
              Kafel va Plitka Kollektsiyasi
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Bizning kafel va plitka kollektsiyamiz uyingizni zamonaviy va hashamatli qilish uchun eng yuqori sifatli materiallarni o'z ichiga oladi.
              Har qanday xona uchun o'ziga xos dizayn yechimlari.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                Kafel va plitka tanlashda yordam kerakmi?
              </h2>
              <p className="text-gray-600 mb-6 md:mb-0">
                Bizning dizaynerlarimiz sizga eng yaxshi variantlarni tanlashda yordam beradi. Biz bilan bog'laning!
              </p>
            </div>
            <a 
