...
export default function MebellPage() {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Uyingiz uchun eng sifatli va zamonaviy mebel kollektsiyasi. Qulay, chiroyli va mustahkam mebellar bilan uyingizni yangi darajaga ko'taring.
            </p>
          </motion.div>
        </div>
      </section>
      
      <Gallery model="mebell" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-6 md:mb-0">
                Bizning dizaynerlarimiz sizga interyeringizga mos mebel tanlashda yordam beradi. Biz bilan bog'laning!
              </p>
            </div>
            <a 
