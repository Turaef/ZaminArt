...
export default function DashikPage() {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">
              Dashik Pollar Kollektsiyasi
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Bizning Dashik pollar kollektsiyamiz noyob uslubga ega va har qanday uy interyeriga o'zgacha ko'rinish beradi.
              Yuqori sifatli materiallardan tayyorlangan ushbu pollar uzoq muddat xizmat qiladi.
            </p>
          </motion.div>
        </div>
      </section>
      
      <Gallery model="dashik" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                Dashik pollar bo'yicha konsultatsiya olishni xohlaysizmi?
              </h2>
