        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Zamonaviy 3D texnologiyalar bilan yaratilgan g'aroyib va noyob dizayn namunalari. 
              Yuqori sifatli materiallar va zamonaviy yechimlar bilan tanishing.
            </p>
          </div>
        </div>
      </section>
      
      {/* Gallery section with dynamic 3D images */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-3">
                3D dizaynlar bo'yicha maslahat olishni xohlaysizmi?
              </h2>
