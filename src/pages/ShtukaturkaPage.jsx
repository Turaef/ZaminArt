        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">
              Dekorativ Shtukaturka Kollektsiyasi
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Dekorativ shtukaturka - bu xonalaringizga o'zgacha go'zallik va tekstura beruvchi zamonaviy qoplama. 
              Turli xil ranglar va fakturalar sizning uyingizga alohida sharm va individuallik qo'shadi.
            </p>
          </motion.div>
        </div>
      </section>
      
      <Gallery model="shtukaturka" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                Dekorativ shtukaturka bo'yicha konsultatsiya olishni xohlaysizmi?
              </h2>
