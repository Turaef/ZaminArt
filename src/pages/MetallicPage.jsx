        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">
              Metallik Pollar Kollektsiyasi
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Bizning metallik pollar kollektsiyamiz zamonaviy va elegant dizayn bilan ajralib turadi. 
              Uzoq muddatli va yuqori sifatli materiallardan tayyorlangan.
            </p>
          </motion.div>
        </div>
      </section>
      
      <Gallery model="metallic" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                Metallik pollar bo'yicha konsultatsiya olishni xohlaysizmi?
              </h2>
