...
import AbstrackGallery from '../components/AbstrackGallery'
import Benefits from '../components/Benefits'

export default function AbstrackPage() {
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Zamonaviy va noyob abstrakt dizayn namunalarimiz bilan tanishing. 
              Har bir dizayn o'zgacha va benzarsiz.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-3">
                Abstrakt dizayn bo'yicha maslahat olishni xohlaysizmi?
              </h2>
